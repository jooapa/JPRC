...
if(WIN32)
    ...
    set(ATRC_LIB_DEBUG "${ATRC_LIB_DEBUG_DIR}/ATRC-${ATRC_ARCH}.lib")
    set(ATRC_LIB_RELEASE "${ATRC_LIB_RELEASE_DIR}/ATRC-${ATRC_ARCH}.lib")
    set(ATRC_DLL_DEBUG "${ATRC_LIB_DEBUG_DIR}/ATRC-${ATRC_ARCH}.dll")
    set(ATRC_DLL_RELEASE "${ATRC_LIB_RELEASE_DIR}/ATRC-${ATRC_ARCH}.dll")

elseif(UNIX)
    set(ATRC_LIB_DIR "${ATRC_ROOT}/Linux/${ATRC_ARCH}")
    set(ATRC_LIB_DEBUG "${ATRC_LIB_DIR}/Debug/libATRC-${ATRC_ARCH}.so")
    set(ATRC_LIB_RELEASE "${ATRC_LIB_DIR}/Release/libATRC-${ATRC_ARCH}.so")
else()
